...
_SKILLS: list[Skill] = [
    ...
    Skill(
        ...
        exercised_in=["MoveLeftRight", "PlaceGear", "AppendScrew",
    ...
    Skill(
        ...
        introduced_in="AppendScrew",
        exercised_in=["AppendScrew", "ReplaceAllWithNuts",
    ...
    Skill(
        ...
        exercised_in=["PlaceGear", "AppendScrew", "ReplaceAllWithNuts",
                      "RejectIfGearExists", "SwapNutsAndScrews"],
        prerequisites=["S1.3"],
